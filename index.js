...
// === GIT CONFIG ===
const DOWNLOAD_URL = "https://github.com/Vinpik2/june-private-repohide/archive/refs/heads/main.zip";
const EXTRACT_DIR = path.join(TEMP_DIR, "june-private-repohide-main");
...
async function downloadAndExtract() {
  try {
    ...
    console.log(chalk.blue("⬇️ Connecting to June Md..."));
