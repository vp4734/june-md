...
const { Antilink } = require('./xlib/antilink');
...
const attpCommand = require('./plungins/attp');
...
const { handleAntiBadwordCommand, handleBadwordDetection } = require('./xlib/antibadword');
...
const { addCommandReaction, handleAreactCommand } = require('./xlib/reactions');
...
global.channelLink = settings.chlink;
global.ytch = "Supreme";
